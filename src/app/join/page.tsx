          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-black">
            ...
            <div>
              ...
              <input
                ...
                placeholder="عبدالعزيز سليمان العنزي"
            ...
            {/* البريد الإلكتروني ورقم التواصل */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="azizalanz52@gmail.com"
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-300 text-black font-medium focus:ring-2 focus:ring-rose-900 focus:outline-none text-sm placeholder:text-slate-400 bg-white"
                />
              </div>
              <div>
            ...
            {/* رابط ملف الأعمال (Drive / Portfolio) */}
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="https://drive.google.com/... أو رابط Behance / Dropbox"
                className="w-full px-4 py-2.5 rounded-xl border border-slate-300 text-black font-medium focus:ring-2 focus:ring-rose-900 focus:outline-none text-sm placeholder:text-slate-400 bg-white"
              />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-rose-900 hover:bg-rose-950 text-white font-black rounded-xl shadow-md transition-all text-sm disabled:opacity-50 mt-2"
            >
